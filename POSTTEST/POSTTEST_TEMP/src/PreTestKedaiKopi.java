...
public class PreTestKedaiKopi {
    public static void main(String[] args) {
        ...
        //  1: Struktur data untuk menyimpan Antrean pelanggan.
        Queue<String> antrean = new LinkedList<>();

        // 2: Struktur data untuk menyimpan Nomor Meja yang sedang dipakai.
        Set<Integer> mejaTerisi = new HashSet<>();

        // 3: Struktur data untuk menyimpan Daftar Harga Menu.
